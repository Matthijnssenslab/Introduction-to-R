...
**Task: Make a scatter plot that shows the sepal length of Iris versicolor on the x axiis and its sepal width on the y axis.**
...
ggplot(only_versicolor, aes(x=Sepal.Length, y=Sepal.Width)) +
  geom_point()
```
